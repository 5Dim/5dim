...
/////////////////////////////  ARMAS   //////////////////////////////////////////////////////
        ...
        $coste->mineral=$fcae*6;
        $coste->cristal=$fcae*2;
        $coste->gas=$fcae*.3;
        $coste->plastico=$fcae*.4;
        $coste->ceramica=$fcae*.5;
        $coste->liquido=$fcae*.5;
        $coste->micros=$fcae*.1;
        $coste->fuel=0;
        $coste->ma=0;
        $coste->municion=$fcae*.01;
        $coste->personal=$fcae*.01;
        $coste->masa=$fcae*1;
        $coste->energia=-$fcae*1;
        $coste->tiempo=$fcae*1.9;
        $coste->mantenimiento=$fcae*.05;
        $coste->defensa=0;
        $coste->ataque=.1;
        $coste->velocidad=0;
        $coste->carga=0;
