...
class CostesInvestigaciones extends Model
{
       ...
       // $investigaciones = Investigaciones::where('jugadores_id', 1)->get();
        ...
        foreach($investigaciones as $investigacion){
            ...
            switch($codigo){
                ...
                $coste = $costesi->calculos($r1cce,$investCorrector,$costosIniciales,$Ifactor,$costoIT);
                break;
            ...
            array_push($costesInvestigacion, $costes);
    ...
    function calculos($r1cce, $investCorrector,$costosIniciales,$Ifactor,$costoIT){
