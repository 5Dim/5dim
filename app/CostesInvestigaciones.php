...
class CostesInvestigaciones extends Model
{
    ...
    function calculos($factorRebajaXMaximo,$r1cce, $investCorrector,$costosIniciales,$Ifactor,$costoIT){
        ...
        $n=1;
        $nivel=$r1cce[11];
        $coste->mineral=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->cristal=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->gas=    (int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->plastico=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->ceramica=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->liquido=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->micros=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->fuel=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->ma=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
        $coste->municion=(int)((pow ($nivel  , ($r1cce[$n] * $Ifactor * $costoIT))) * $costosIniciales[$n]) * $investCorrector * $factorRebajaXMaximo; $n++;
