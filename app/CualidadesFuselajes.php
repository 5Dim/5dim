...
class CualidadesFuselajes extends Model
{
    ...
    public function  generarDatosCualidadesFuselajes($codigo, $fuselajes_id)
    {
        ...
        switch($codigo){
            ...
            $CRnave5 = 0; 	// DEFENSAS, cantidad por tipo
            $CRnave6 = 0; 	// BOMBAS, cantidad por tipo  ***  selectedA1 *
            $CRnave7 = 36; 	// cañones Misiles, cantidad por tipo
            $CRnave8 = 0; 	// CARGA PEQUEÑA, cantidad por tipo
            $CRnave9 = 0; 	// MEDIANA, cantidad por tipo
            $CRnave10 = 0;	 //CARGA GRANDE, cantidad por tipo
            $CRnave14 = 0;    //Carga ENorme
            ...
            //TROPAS///////////////////////////////////////////////////////////////////////
            case  "Infanteria 1": //Basada en la HACHIMAN
            $Tnavet = "infanteria";
            $Tnave = 1;
            $inirec8=1;
            $inirec11=2;
            ...
            case  "Infanteria 2": //Basada en la AMATERATSU
            $Tnavet = "infanteria";
            $Tnave = 1;
            $inirec8=1.5;
            $inirec11=75;
            ...
            case  "Infanteria 3": //Basada en la SUSANOO
            $Tnavet = "infanteria";
            $Tnave = 1;
            $inirec8=1.8;
            $inirec11=4;
            ...
            case  "Infanteria 4": //Basada en la IZANAMI
            $Tnavet = "infanteria";
            $Tnave = 1;
            $inirec8=1;
            $inirec11=10;
            ...
            case  "Infanteria 5": //Basada en la RAIJIN
            $Tnavet = "infanteria";
            $Tnave = 1;
            $inirec8=1;
            $inirec11=10;
            ...
            case  "Avion 1": //Basada en la ARTEMISA
            $Tnavet = "avion";
            $Tnave = 0;
            $inirec8=1;
            $inirec11=2;
            ...
            case  "Avion 2": //Basada en la CRONOS
            $Tnavet = "avion";
            $Tnave = 0;
            $inirec8=1;
            $inirec11=20;
            ...
            case  "Avion 3": //Basada en la NEMESIS
            $Tnavet = "avion";
            $Tnave = 0;
            $inirec8=0;
            $inirec11=1;
            ...
            case  "Avion 4": //Basada en la ARES
            $Tnavet = "avion";
            $Tnave = 0;
            $inirec8=1;
            $inirec11=1;
            ...
            case  "Avion 5": //Basada en la ZEUS
            $Tnavet = "avion";
            $Tnave = 0;
            $inirec8=1.2;
            $inirec11=2;
