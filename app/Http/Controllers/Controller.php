...
class Controller extends BaseController
{
    ...
    public function recursos()
    {
        ...
        $planetasJugador = Planetas::where('jugadores_id', $jugadorActual->id)->orderBy('orden')->orderBy('creacion')->get();
        ...
        if (
            ...
            $planetasAlianza = Planetas::where('jugadores_id', $jugadorAlianza->id)->orderBy('orden')->orderBy('creacion')->get();
        }
