...
class DiseñoController extends Controller
{
    ...
    public function diseñar ($idFuselaje)
    {
        ...
        return view('juego.diseñar.diseñar', compact('recursos', 'almacenes', 'producciones', 'personal', 'tipoPlaneta', 'planetaActual',
        'diseño', 'nivelImperio', 'nivelEnsamblajeNaves', 'nivelEnsamblajeDefensas', 'nivelEnsamblajeTropas','investigaciones', 'armas',
        'constantesI', 'costesArmas', 'factoresIndustrias', 'planetasJugador', 'planetasAlianza'));
    }
