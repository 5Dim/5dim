...
class CostesArmas extends Model
{
    ...
    public static function generarDatosCostesArmas()
    {
        ...
        $coste->tiempo = $fcap * 1900;
        $coste->mantenimiento = $fcap * $fcbomb;
        $coste->defensa = 0;
        $coste->ataque = 10000;
        $coste->velocidad = 0;
        $coste->carga = 0;
        ...
        $coste->tiempo = $fcab * 1900;
        $coste->mantenimiento = $fcab * $fcbomb;
        $coste->defensa = 0;
        $coste->ataque = 7000;
        $coste->velocidad = 0;
        $coste->carga = 0;
        ...
        $coste->tiempo = $fcam * 1900;
        $coste->mantenimiento = $fcam * $fcbomb;
        $coste->defensa = 0;
        $coste->ataque = 13000;
        $coste->velocidad = 0;
        $coste->carga = 0;
