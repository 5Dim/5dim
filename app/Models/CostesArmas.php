...
class CostesArmas extends Model
{
    ...
    public function  generarDatosCostesArmas(){
        ...
        $fcbomb=4; //factor reduccion costos bombas
            ...
            $coste =new CostesArmas();
            $coste->armas_codigo=$niveltec+69;$niveltec++; // foco estaciones
            $coste->mineral=50; //esto para todos
            $coste->cristal=10;
            $coste->gas=10;
            $coste->plastico=10; //4
...
/////////////////////////////  ARMAS   //////////////////////////////////////////////////////
        ...
        $coste->fuel=0;
        $coste->ma=0;
        $coste->municion=$fcae*15;
        $coste->personal=$fcae*1;
        $coste->masa=$factorPesoArmas*$fcae*1500 * 2;
        ...
        $coste->municion=$fcae*15;
        $coste->personal=$fcae*1;
        $coste->masa=$factorPesoArmas*$fcae*1500 * 4;
        ...
        $coste->municion=$fcae*15;
        $coste->personal=$fcae*1;
        $coste->masa=$factorPesoArmas*$fcae*1500 * 8;
        ...
        $coste->municion=$fcae*15;
        $coste->personal=$fcae*1;
        $coste->masa=$factorPesoArmas*$fcae*1500 * 16;
