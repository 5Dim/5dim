...
/////////////////////////////  ARMAS   //////////////////////////////////////////////////////
        ...
        $coste->liquido=$fcae*400 * 60;
        $coste->micros=$fcae*80 * 60;      //-
        $coste->fuel=0;
        $coste->ma=0;
        $coste->municion=$fcae*10;
        $coste->personal=$fcae*1;
        $coste->masa=$factorPesoArmas*$fcae*1000 * 2;
        $coste->energia=-$fcae*30; //determina su potencia(a menos mas)
        $coste->tiempo=$fcae*1900;
        $coste->mantenimiento=$fcae*50;
        $coste->defensa=0;
        $coste->ataque=9000;
        ...
        $coste->liquido=$fcae*350 * 60;  //-
        $coste->micros=$fcae*100 * 60;
        $coste->fuel=0;
        $coste->ma=0;
        $coste->municion=$fcae*10;
        $coste->personal=$fcae*1;
        $coste->masa=$factorPesoArmas*$fcae*1000 * 2;
        $coste->energia=-$fcae*25;
        $coste->tiempo=$fcae*1900;
        $coste->mantenimiento=$fcae*50;
        $coste->defensa=0;
        $coste->ataque=10000;
