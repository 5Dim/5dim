...
class CostesBasicosConstruccion extends Model
{
    ...
    public function  generarDatosCostesBasicosConstruccion()
    {
        ...
        //FALTAN
        $costesc = new CostesBasicosConstruccion();
        $costesc->codigo = "terraformadorMinero";
        $costesc->mineral = 80;
        $costesc->cristal = 60;
        $costesc->gas = 40.;
        $costesc->plastico = .3;
        ...
        $costesc = new CostesBasicosConstruccion();
        $costesc->codigo = "terraformadorIndustrial";
        $costesc->mineral = 80;
        $costesc->cristal = 60;
        $costesc->gas = 40.;
        $costesc->plastico = .3;
        ...
        $costesc = new CostesBasicosConstruccion();
        $costesc->codigo = "redInvestigacion";
        $costesc->mineral = 3.5;
        $costesc->cristal = 2.8;
        $costesc->gas = 2;
        $costesc->plastico = 2.8;
        ...
        $costesc = new CostesBasicosConstruccion();
        $costesc->codigo = "redObservatorios";
        $costesc->mineral = 3.5;
        $costesc->cristal = 2.8;
        $costesc->gas = 2;
        $costesc->plastico = 2.8;
        ...
        $costesc = new CostesBasicosConstruccion();
        $costesc->codigo = "teleportNodriza";
        $costesc->mineral = 3.5;
        $costesc->cristal = 2.8;
        $costesc->gas = 2;
        $costesc->plastico = 2.8;
