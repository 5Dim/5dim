...
class CostesBasicosInvestigacion extends Model
{
    ...
    public function  generarDatosCostesBasicosConstruccion()
    {
        ...
        $valores=["invCarga","costoInvestDisenio","descuentoMInvestDisenio","descuentoCInvestArmas",2,2,2,2,2,2,2,2,2,2,15000,0,0,0,0,0,0,0,0,0];calculos($valores);
        $valores=["invBlindaje","costoInvestDisenio","descuentoMInvestDisenio","descuentoCInvestArmas",2,2,2,2,2,2,2,2,2,2,1000,0,0,0,12000,0,0,0,0,1200];calculos($valores);
        $valores=["invIa","costoInvestDisenio","descuentoMInvestDisenio","descuentoCInvestArmas",2,1.9,2,2,2,2,2.5,2,2,2,0,1000,0,0,0,1000,10000,0,0,0];calculos($valores);
