...
class CostesInvestigaciones extends Model
{
            ...
            if (isset($investigacion->nivel)) {
                ...
                switch ($codigo) {
                    case "invEnergia":
                        ...
                        $coste = $costesi->calculos($factorRebajaXMaximo, $r1cce, $investCorrector, $costosIniciales, $Ifactor, $costoIT, $costoPorAlianza);
                        break;
    ...
    function calculos($factorRebajaXMaximo, $r1cce, $investCorrector, $costosIniciales, $Ifactor, $costoIT, $costePorAlianza)
    {
