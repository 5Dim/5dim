...
class Mensajes extends Model
{
    ...
    public static function transporte($destino)
    {
        ...
        $contenido .= "</b> con mision <b>transportar</b>.</p> <table class='table table-sm table-borderless text-center anchofijo align-middle'> <tr> <td class='text-success'> Accion </td> <td class='text-warning'> Personal </td> <td class='text-warning'> Mineral </td> <td class='text-warning'> Cristal </td> <td class='text-warning'> Gas </td> <td class='text-warning'> Plástico </td> <td class='text-warning'> Cerámica </td> <td class='text-warning'> Líquido </td> <td class='text-warning'> Micros </td> <td class='text-warning'> Fuel </td> <td class='text-warning'> MA </td> <td class='text-warning'> Munición </td> <td class='text-warning'> Créditos </td> </tr>";
    ...
    public static function transferir($destino)
    {
        ...
        $contenido .= "<tr> <td class='text-warning'> En destino </td> <td class='text-light'>" . number_format($recursosQueTienes->personal, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->mineral, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->cristal, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->gas, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->plastico, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->ceramica, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->liquido, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->micros, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->fuel, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->ma, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->municion, 0, ',', '.') . "</td> <td class='text-light'>" . number_format($recursosQueTienes->creditos, 0, ',', '.') . "</td> </tr>";
        $contenido .= "<tr> <td class='text-warning'> Dejas </td> <td class='text-success'>" . number_format($destino->recursos->personal, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->mineral, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->cristal, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->gas, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->plastico, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->ceramica, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->liquido, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->micros, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->fuel, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->ma, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->municion, 0, ',', '.') . "</td> <td class='text-success'>" . number_format($destino->recursos->creditos, 0, ',', '.') . "</td> </tr>";
        $contenido .= " </table> ";
