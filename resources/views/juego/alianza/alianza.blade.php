...
<div class="container">
    <nav>
        <div class="nav nav-pills nav-justified" id="nav-tab" role="tablist" style="border: 0px; margin: 5px"
            ...
            <a class="nav-item nav-link" id="miembros-tab" data-toggle="tab" href="#miembros" role="tab"
                aria-controls="miembros" aria-selected="false">
                Miembros
            </a>
            <a class="nav-item nav-link" id="solicitudes-tab" data-toggle="tab" href="#solicitudes" role="tab"
