            ...
            <div class="col-12 rounded cajita">
                <div id="cuadro1" class="table-responsive">
                    <form method="POST" action="{{ url('juego/solicitudAlianza') }}" style="margin: 10px;">
                        @csrf
                        <table class="table table-borderless table-sm text-center anchofijo"
                            ...
                            <tr>
                                <td class="anchofijo text-secondary ">
                                    <select name="listaAlianzas" id="listaAlianzas" class="form-control">
                                        ...
                                        <option value="{{$alianza->id}}">[{{ $alianza->tag }}] {{ $alianza->nombre }}
                                        </option>
                                        @endforeach
                                    </select>
                                </td>
                            ...
                            <tr>
                                <td colspan="2" class="anchofijo text-secondary ">
                                    <textarea class="ckeditor" name="solicitud"
                                        id="solicitud">Mensaje de solicitud</textarea>
                                </td>
                            </tr>
                        </table>
                    </form>
                            ...
                            <tr>
                                <td class="anchofijo text-secondary borderless">
                                    <div class="input-group mb-4 "
                                        ...
                                        <input type="text" class="form-control input" name="nombre" id="nombre"
                                            placeholder="Nombre oficial de la alianza" aria-label="Recipient's username"
                                ...
                                <td class="anchofijo text-secondary borderless">
                                    <div class="input-group mb-4 "
                                        ...
                                        <input type="text" class="form-control input" name="tag" id="tag"
                                            placeholder="Tag de la alianza" aria-label="Recipient's username"
                                            aria-describedby="basic-addon2">
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td class="anchofijo text-secondary borderless">
                                    <div class="input-group mb-4 "
                                        style="padding-left: 5px !important; padding-right: 5px !important">
                                        <div class="input-group-append">
                                            <span class="input-group-text bg-dark text-light">Estandarte
                                                (60x60px)</span>
                                        </div>
