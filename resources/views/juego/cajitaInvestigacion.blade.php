                ...
                <table class="table table-borderless borderless table-sm text-center anchofijo" style="margin-top: 5px !important">
                    <tr>
                        ...
                        <td colspan="2" class="text-success text-right borderless align-middle"><input id="{{ 'personal' . $investigacion->codigo }}" type="number" class="personal1"
                                placeholder="personal" value="{{$personal}}" onkeyup="calculaTiempoInvestigacion({{$investigacion->coste->mineral+$investigacion->coste->cristal+$investigacion->coste->gas+$investigacion->coste->plastico +$investigacion->coste->ceramica +$investigacion->coste->liquido + $investigacion->coste->micros + $investigacion->coste->fuel+ $investigacion->coste->ma+ $investigacion->coste->municion }} ,{{$velInvest->valor}}, '{{$investigacion->codigo}}','{{!empty($investigacion->enInvestigaciones[0]->nivel) ? $investigacion->enInvestigaciones[count($investigacion->enInvestigaciones)-1]->nivel  : $investigacion->nivel}}','{{$nivelLaboratorio->nivel}}') "></td>
                    </tr>
                    <tr>
