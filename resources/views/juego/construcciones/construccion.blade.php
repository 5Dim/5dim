        ...
        <div class="container-fluid">
            ...
            <nav>
                <div class="nav nav-pills nav-justified" id="nav-tab" role="tablist" style="border: 0px; margin: 5px"
                    align="center">
                    <a class="nav-item nav-link  active" id="mina-tab" data-bs-toggle="tab" href="#mina" role="tab" aria-controls="mina"
                        aria-selected="true">
                        Minas
                    </a>
                    ...
                    <a class="nav-item nav-link" id="especialidades-tab" data-bs-toggle="tab" href="#especialidades" role="tab"
