    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div id="cuadro1" class="table-responsive">
                    <table class="table table-borderless borderless table-sm text-center anchofijo"
                        ...
                        @for ($i = 0 ; $i < count($colaConstruccion) ; $i++) <tr>
        ...
        <nav>
            <div class="nav nav-pills nav-justified" id="nav-tab" role="tablist" style="border: 0px; margin: 5px"
                align="center">
                <a class="nav-item nav-link  active" id="mina-tab" data-toggle="tab" href="#mina" role="tab"
                    aria-controls="mina" aria-selected="true">
                    Minas
                </a>
                <a class="nav-item nav-link" id="industria-tab" data-toggle="tab" href="#industria" role="tab"
                    aria-controls="industria" aria-selected="false">
                    Industrias
                </a>
                <a class="nav-item nav-link" id="almacenes-tab" data-toggle="tab" href="#almacenes" role="tab"
                    aria-controls="almacenes" aria-selected="false">
                    Almacenes
                </a>
                <a class="nav-item nav-link" id="militares-tab" data-toggle="tab" href="#militares" role="tab"
                    aria-controls="militares" aria-selected="false">
                    Militares
                </a>
                <a class="nav-item nav-link" id="desarrollo-tab" data-toggle="tab" href="#desarrollo" role="tab"
                    aria-controls="desarrollo" aria-selected="false">
                    Desarrollo
                </a>
                <a class="nav-item nav-link" id="observacion-tab" data-toggle="tab" href="#observacion" role="tab"
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="mina" role="tabpanel" aria-labelledby="mina-tab">
                @for ($i = 0 ; $i < 6 ; $i++) @include('juego.construcciones.cajitaConstruccion', [ 'construccion'=>
                    $construcciones[$i],
            ...
            <div class="tab-pane fade" id="industria" role="tabpanel" aria-labelledby="industria-tab">
                @for ($i = 6 ; $i < 11 ; $i++) @include('juego.construcciones.cajitaConstruccion', [ 'construccion'=>
                    $construcciones[$i],
                    'costesCons' => $costesConstrucciones[$i],
                    'personal' => $recursos->personal - $personal,
                    'tab' => 'industria-tab',
            ...
            <div class="tab-pane fade " id="almacenes" role="tabpanel " aria-labelledby="almacenes-tab">
                ...
                @endphp
                @endif
                @for ($i = 13 ; $i < 21 ; $i++) @include('juego.construcciones.cajitaConstruccion', [ 'construccion'=>
                    $construcciones[$i],
                    'costesCons' => $costesConstrucciones[$i],
                    'personal' => $recursos->personal - $personal,
                    'tab' => 'almacenes-tab',
            ...
            <div class="tab-pane fade" id="militares" role="tabpanel" aria-labelledby="militares-tab">
                @for ($i = 21 ; $i < 26 ; $i++) @include('juego.construcciones.cajitaConstruccion', [ 'construccion'=>
                    $construcciones[$i],
                    'costesCons' => $costesConstrucciones[$i],
                    'personal' => $recursos->personal - $personal,
                    'tab' => 'militares-tab',
            ...
            <div class="tab-pane fade" id="desarrollo" role="tabpanel" aria-labelledby="desarrollo-tab">
                @for ($i = 26 ; $i < 29 ; $i++) @include('juego.construcciones.cajitaConstruccion', [ 'construccion'=>
                    $construcciones[$i],
                    'costesCons' => $costesConstrucciones[$i],
                    'personal' => $recursos->personal - $personal,
                    'tab' => 'desarrollo-tab',
            ...
            <div class="tab-pane fade" id="observacion" role="tabpanel" aria-labelledby="observacion-tab">
                @for ($i = 29 ; $i < 32 ; $i++) @include('juego.construcciones.cajitaConstruccion', [ 'construccion'=>
                    $construcciones[$i],
                    'costesCons' => $costesConstrucciones[$i],
                    'personal' => $recursos->personal - $personal,
                    'tab' => 'observacion-tab',
