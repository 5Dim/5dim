                ...
                <tr>
                    <td>
                        <button type="button" class="btn btn-outline-primary btn-block btn-sm " data-toggle="modal"
                            data-target="#datosModal" onclick="mostrarDatosFuselaje('{{$fuselaje->id}}')">
                    ...
                    @endphp
                    <td>
                        <button type="button" class="btn btn-outline-{{$clase}} btn-block btn-sm"
                            onclick="sendDiseniar('{{$fuselaje->id}}')" {{$desabilitado}}>
