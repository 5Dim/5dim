            ...
            <table class="table table-borderless borderless table-sm text-center anchofijo"
                ...
                <tr>
                    <td rowspan="4" class="anchofijo text-warning borderless">
                        <img class="rounded" src="{{ asset('img/fotos naves/skin1/naveMT' . $fuselaje->id . '.jpg') }}"
                            width="180" height="119">
                    </td>
                    <td rowspan="4" colspan="9" class="anchofijo text-warning borderless">
                        <textarea name="" id="" rows="4" style="width: 100%" class="text-light text-left textarea"
                            disabled>
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-outline-success btn-block btn-sm"
                            onclick="sendDesbloquear('{{$fuselaje->id}}')">
