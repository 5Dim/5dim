    ...
    <div class="container-fluid">
            ...
            <div class="col-12">
                <div id="cuadro1" class="table-responsive">
                    <table class="table table-borderless borderless table-sm text-center anchofijo"
                        ...
                        @for ($i = 0 ; $i < count($colaInvestigacion) ; $i++) <tr>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="militares" role="tabpanel" aria-labelledby="militares-tab">
                @for ($i = 0 ; $i < 4 ; $i++) @include('juego.investigaciones.cajitaInvestigacion', [ 'investigacion'=>
                    $investigaciones[$i],
            ...
            <div class="tab-pane fade" id="misc" role="tabpanel" aria-labelledby="misc-tab">
                @for ($i = 4 ; $i < 7 ; $i++) @include('juego.investigaciones.cajitaInvestigacion', [ 'investigacion'=>
                    $investigaciones[$i],
                    'costeInv' => $costeInvestigaciones[$i],
                    'personal' => $recursos->personal - $personal,
                    ])
            ...
            <div class="tab-pane fade " id="personales" role="tabpanel " aria-labelledby="personales-tab">
                @for ($i = 7 ; $i < 12 ; $i++) @include('juego.investigaciones.cajitaInvestigacion', [ 'investigacion'=>
                    $investigaciones[$i],
                    'costeInv' => $costeInvestigaciones[$i],
                    'personal' => $recursos->personal - $personal,
                    ])
            ...
            <div class="tab-pane fade" id="motores" role="tabpanel" aria-labelledby="motores-tab">
                @for ($i = 12 ; $i < 18 ; $i++) @include('juego.investigaciones.cajitaInvestigacion',
            ...
            <div class="tab-pane fade" id="industrias" role="tabpanel" aria-labelledby="industrias-tab">
                @for ($i = 18 ; $i < 23 ; $i++) @include('juego.investigaciones.cajitaInvestigacion',
                    [ 'investigacion'=> $investigaciones[$i],
                    'costeInv' => $costeInvestigaciones[$i],
                    'personal' => $recursos->personal - $personal,
                    ])
