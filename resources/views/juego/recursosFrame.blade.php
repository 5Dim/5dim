            ...
            <thead >
                <tr>
                    ...
                    <th scope="col" class="text-warning borderless centradoCeldas">
                        ...
                        /th>
                    <th scope="col" class="text-warning borderless centradoCeldas">
                        <a href="estadisticas.php" target="_self"><img src="{{ asset('img/elJuego/skin0/icons/ico-barra-est.png') }}"  title="Estadisticas"/>
                        </a>
                    </th>
                    <th scope="col" class="text-warning borderless centradoCeldas">
                        <a href="http://es.5dim.wikia.com/wiki/Wiki_5dim" target="_blank"><img src="{{ asset('img/elJuego/skin0/icons/ico-barra-wik.png') }}"  title="Wikia"/>
                        </a>
                    </th>
                    <th scope="col" class="text-warning borderless centradoCeldas">
                        <a href="http://quintadim.foroactivo.com/f21-ayudas-y-preguntas" target="_blank"><img src="{{ asset('img/elJuego/skin0/icons/ico-barra-sop.png') }}"  title="Soporte"/>
                        </a>
                    </th>
