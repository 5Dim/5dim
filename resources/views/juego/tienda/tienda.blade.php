    ...
    <div class="container-fluid">
        ...
        <nav>
            <div class="nav nav-pills nav-justified" id="nav-tab" role="tablist" style="border: 0px; margin: 5px" align="center">
                ...
                <a class="nav-item nav-link" id="compra-tab" data-toggle="tab" href="#compra" role="tab" aria-controls="compra" aria-selected="false">
                    Compra novas
                </a>
                <a class="nav-item nav-link" id="canjear-tab" data-toggle="tab" href="#canjear" role="tab" aria-controls="canjear" aria-selected="false">
                    Canjea tu codigo
                </a>
            </div>
        </nav>
