            ...
            <h5 class="text-light text-center">
                ...
                <nav>
                    <div class="nav nav-pills nav-justified" id="nav-tab" role="tablist"
                        ...
                        <a class="nav-item nav-link active" id="tienda-tab" data-toggle="tab" href="#tienda" role="tab"
                            aria-controls="tienda" aria-selected="true">
                            Tienda
                        </a>
                        <a class="nav-item nav-link" id="compra-tab" data-toggle="tab" href="#compra" role="tab"
                            aria-controls="compra" aria-selected="false">
                            Compra novas
                        </a>
                        <a class="nav-item nav-link" id="canjear-tab" data-toggle="tab" href="#canjear" role="tab"
